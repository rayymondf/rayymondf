<h1 align="center">Hi, I'm Raymond Fang 👋</h1>
...
<h4 align="center">
  <a href="mailto:rayymondf29@gmail.com">rayymondf29@gmail.com</a>
</h4>
...
A browser-based task manager that lets users create projects, add todos, assign priorities/due dates, sort tasks, and persist data locally.

- Built without a framework to strengthen core JavaScript fundamentals
- Implemented project-based task organization and editable todo cards
- Used `localStorage` to persist projects and todos after refresh
- Added sorting by newest, due date, priority, and priority/date

[Repository](https://github.com/rayymondf/Todo-List-Project) • [Live Demo](https://rayymondf.github.io/Todo-List-Project/)
